...
parser.add_option('-g', default='gene_fpkm_matrix.csv', help="where to output the gene fpkm matrix [default: %default")
parser.add_option('-t', default='transcript_fpkm_matrix.csv', help="where to output the transcript fpkm matrix [default: %default]")
...
##                        transcriptList.append((g_id, t_id, int(ceil(coverage*transcript_len/read_len))))
                    ...
                    t_dict[t_id].setdefault(s[0], fpkm)
